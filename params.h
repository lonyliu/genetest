...
//! @ DNA parameters
#if 1
#define SNPlen 10	 	// length of SNP that we will consider
#define SNPbits 21	 	// 2*SNPlen + 1 // bits of SNPs
#define nSNP 4 		 	// SNPlen2/logT // REF, ALT - > nSNP partition
